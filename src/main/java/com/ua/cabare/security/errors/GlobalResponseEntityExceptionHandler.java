...
public class GlobalResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers,
    ...
    GenericResponse response = new GenericResponse(result.getAllErrors(), "Invalid" + result.getObjectName());
  ...
  public ResponseEntity<Object> handleAuthenticationFailure(RuntimeException ex, WebRequest request) {
    logger.error("403 Status Code ", ex);
    GenericResponse response = new GenericResponse(messageSource.getMessage("auth.message.authError",
  ...
  public ResponseEntity<Object> handleEmployeeNotFound(RuntimeException ex, WebRequest request) {
    ...
    GenericResponse response = new GenericResponse(messageSource.getMessage("message.employeeNotFound",
        null, request.getLocale()), "EmployeeNotFound");
    return handleExceptionInternal(ex, response, new HttpHeaders(), HttpStatus.NOT_FOUND, request);
  }

  @ExceptionHandler({EmployeeAlreadyExistException.class})
  public ResponseEntity<Object> handleEmployeeAlreadyExist(RuntimeException ex, WebRequest request) {
  ...
  public ResponseEntity<Object> handleMail(RuntimeException ex, WebRequest request) {
    ...
    GenericResponse response = new GenericResponse(messageSource.getMessage("message.email.config.error",
